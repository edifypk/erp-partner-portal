...
const AvatarPicker = ({ children, className, saveMessage, onSave, path = 'uploads/temp-images', onUploadSuccess, type = "avatar", showBackgroundRemoval = true }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => {
            ...
            <DialogContent
                ...
                className={cn("max-w-xl max-h-[90vh] overflow-hidden border-0",
                                ...
                                <div>
                                    {isCameraActive ? (
                                        ...
                                        <div className='text-center'>
                                            <div className='relative w-48 h-48 mx-auto mb-4'>
                                                <video
                                                    ...
                                                    playsInline
                                                    muted
                                                    className='w-full h-full rounded-full object-cover border-2 border-gray-200 transform scale-x-[-1]'
                                                />
                                        ...
                                        <>
                                            ...
                                            <img className='' src={type == "logo" ? "/images/placeholder/image.svg" : "/images/placeholder/male.png"} alt="" />
                                            </div>
                                            <div className='flex justify-center items-center gap-2 mb-4'>
                ...
                >
                    <div>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='w-36 mx-auto h-36 border border-gray-300 shadow-md rounded-full relative overflow-hidden mb-4'>


                                {
                                    processedImage ?
                                        <>
                                            <img src={processedImage ? URL.createObjectURL(processedImage) : "/images/placeholder/male.png"} className='absolute inset-0 w-full h-full object-cover object-center rounded-full' alt="" />
                                            <motion.img
                                                src={croppedImage ? URL.createObjectURL(croppedImage) : "/images/placeholder/male.png"}
                                                className='w-full absolute inset-0 h-full object-cover object-center rounded-full' alt=""
                                        ...
                                        :
                                        <>
                                            <img src={croppedImage ? URL.createObjectURL(croppedImage) : "/images/placeholder/male.png"} className='w-full h-full object-cover object-center rounded-full' alt="" />
                                        </>
                                }
