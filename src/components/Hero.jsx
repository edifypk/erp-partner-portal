            ...
            <div className='absolute inset-0 p-6 bg-linear-to-r from-black/30 to-transparent'>
                <div className='max-w-7xl mx-auto h-full flex flex-col justify-center'>
                    <div className='max-w-2xl'>
                        <h1 className='text-5xl text-shadow-lg/30 tracking-tighter font-semibold text-white'>Power your success <br /> with Edify Group</h1>
                        <p className='font-medium text-shadow-lg/50 tracking-normal my-6 text-white'>Experience seamless global student recruitment through trusted partnerships, advanced technology, and dedicated support that helps your business grow.</p>
