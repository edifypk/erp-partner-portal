    ...
    return (
        <div className='flex items-center gap-2'>
            ...
            <div className='text-left'>
                <div className={cn('text-xs dark:text-neutral-300 text-neutral-600 font-semibold  whitespace-nowrap tracking-tight', theme === "light" ? "text-white" : "text-black")}>{user?.contact?.name}</div>
